                    ...
                    <div className="row">
                        <div className="col-xl-6 text-center mt-5 mt-xl-0 order-2 order-xl-1">
                            <div className="cta-mobile">
                                <img src="/img/lead/child.png" alt="" />
                            </div>
                        </div>
                        <div className="text-center text-xl-start col-xl-6 order-1 order-xl-2">
                            <div className="cta-contents pe-lg-5">
                                <h2 className="wow fadeInUp">Create An account now!</h2>
                                <p className="wow fadeInUp" data-wow-delay=".3s">Our Posts are though based and fact checked making learning fun.</p>
